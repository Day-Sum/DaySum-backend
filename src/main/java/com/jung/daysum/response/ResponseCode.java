...
public enum ResponseCode {
    ...
    BAD_REQUEST_STORAGE(StatusItem.BAD_REQUEST, MessageItem.BAD_REQUEST_STORAGE),
    STORAGE_ERROR(StatusItem.INTERNAL_SERVER_ERROR, MessageItem.STORAGE_ERROR),UPDATE_DAILY_RECORD_PHOTO(StatusItem.OK, MessageItem.UPDATE_DAILY_RECORD_PHOTO),
    DELETE_DAILY_RECORD_PHOTO(StatusItem.NO_CONTENT, MessageItem.DELETE_DAILY_RECORD_PHOTO),
    UPDATE_DAILY_RECORD_DRAWING(StatusItem.OK, MessageItem.UPDATE_DAILY_RECORD_DRAWING),
    DELETE_DAILY_RECORD_DRAWING(StatusItem.NO_CONTENT, MessageItem.DELETE_DAILY_RECORD_DRAWING),
    BAD_REQUEST_MUSIC(StatusItem.BAD_REQUEST, MessageItem.BAD_REQUEST_MUSIC),
    MUSIC_SERVER_ERROR(StatusItem.INTERNAL_SERVER_ERROR, MessageItem.MUSIC_SERVER_ERROR),

    // Music
    READ_MUSIC_SEARCH(StatusItem.OK, MessageItem.READ_MUSIC_SEARCH),
    UPDATE_DAILY_RECORD_MUSIC(StatusItem.OK, MessageItem.UPDATE_DAILY_RECORD_MUSIC),
    DELETE_DAILY_RECORD_MUSIC(StatusItem.NO_CONTENT, MessageItem.DELETE_DAILY_RECORD_MUSIC),

    // Activity
    CREATED_ACTIVITY(StatusItem.CREATED, MessageItem.CREATED_ACTIVITY),
    DELETE_CURRENT_ACTIVITY(StatusItem.NO_CONTENT, MessageItem.DELETE_CURRENT_ACTIVITY),
